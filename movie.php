<?php
    ...
    if(empty($id)){ // Mensagem de erro caso esteja vazio
        ...
        if((!$movie)){ // Mensagem de erro caso não exista

            $message->setMessage("O filme não foi encontrado.", "error", "index.php");
        }
    }

    // Verifica se o filme não possui imagem
    if($movie->image == ""){
        $movie->image = "movie_cover.jpg";
    }

    // Lógica se verifica se o filme é do usuário para habilitar as reviews
    $userOwnsMovie = false;
    if(!empty($userData)){ // Verifica se possui algum usuário
    ...
    <div id="main-container" class="container-fluid">
        <div class="row">
            ...
            <div class="offset-md-1 col-md-10" id="reviews-container">
                ...
                <!-- Lógica que verifica se o usuário pode comentar ou não: Se existe usuário, se ele não é o dono do filme e se ele nunca comentou -->
