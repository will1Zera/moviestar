<?php
    ...
    // Chama a função para gerar o nome completo
    $user = new User();
    ...
    <div id="main-container" class="container-fluid edit-profile-page">
        <div class="col-md-12">
               ...
               <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="bio" class="form-control" id="bio" rows="5" placeholder="Conta um pouco mais sobre você..."><?= $userData->bio ?></textarea>
                        </div>
                    </div>
               </div> 
            </form>
            ...
            <div class="row" id="change-password-container">
               <div class="col-md-4">
                    <h2>Alterar senha</h2>
                    <p class="page-description">Digite a sua nova senha e confirme para alterar:</p>
